...
# In api_ollama_integration.py
    ...
    **CONVERSATIONAL BOOKING FLOW (BUTTON-DRIVEN):**
    ...
    - **Step 5: Confirm & Book.** After the user chooses a time, your action MUST be `FINALIZE_BOOKING`.
      `{"response": "Got it! I am confirming your appointment with Dr. Aarav Sharma for 07:30 PM.", "action": "FINALIZE_BOOKING", "parameters": {"doctorName": "Aarav Sharma", "dateTime": "2025-10-15T19:30:00"}, "interactive_buttons": []}`
    """
